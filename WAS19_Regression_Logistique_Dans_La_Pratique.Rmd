---
title: "Régression Logistique dans la pratique"
author: "wilga prefina MBANI"
date: "`r Sys.Date()`"
output: 
  word_document:
    toc: true
...
predicted_classes <- ifelse(pred > 0.55, 1, 0)

# Afficher les résultats
df=data.frame(Probabilities = pred, Predicted_Classes = predicted_classes)
df$Probabilities
```
